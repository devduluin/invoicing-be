...
type PurchaseInvoiceController struct{ svc domain.IService }

func NewPurchaseInvoiceController(svc domain.IService) *PurchaseInvoiceController {
	return &PurchaseInvoiceController{svc: svc}
}
